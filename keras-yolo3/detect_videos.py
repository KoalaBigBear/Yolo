...
def detect_video(yolo, video_path, output_path):
    ...
    elif video_path.isnumeric() == False:
    ...
    while True:
        ...
        if return_value == True:         
            ...
            if i <= 9:
                cv2.imwrite(os.path.join(output_path , '000%d.jpg'%i), result)
                print( '000%d.jpg'%i)
            elif i > 9 and i <= 99:
                cv2.imwrite( os.path.join(output_path , '00%d.jpg'%i), result)
                print( '00%d.jpg'%i)
            elif i > 99 and i <= 999:
                cv2.imwrite(os.path.join(output_path , '0%d.jpg'%i), result)
                print( '0%d.jpg'%i)
            elif i > 999 and i <= 9999:
                cv2.imwrite( os.path.join(output_path , '%d.jpg'%i), result)
                print( '%d.jpg'%i)
            else:
                print('Out of Range')
            i += 1
...
if __name__ == '__main__':
    ...
    if "input" in FLAGS:
        ...
        for i in range(len(result)):
            if result[i].endswith(".jpg") or result[i].endswith(".png"):
                image_path = dirPath + result[i]
